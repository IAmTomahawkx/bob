...
class Timers(commands.Cog):
    ...
    async def schedule_task(self, event: str, dispatch_at: datetime.datetime, *args, conn: asyncpg.Connection = None, **kwargs) -> asyncpg.Record:
        ...
        if conn:
            ...
            data = await self.bot.db.fetchrow(query, dispatch_at, event, ujson.dumps({"args": list(args), "kwargs": kwargs}))
